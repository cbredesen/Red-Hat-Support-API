...
public interface AccountsResource {
	...
	public void createFolder(final @PathParam("accountNumber") String accountNumber,
			@Mapped(namespaceMap = {@XmlNsMap(namespace = "http://www.redhat.com/gss/strata", jsonName = "strata")}) Group gropu);
	...
	@Path("/{accountNumber}/folders/{folderNumber}")
	@Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_XML})
	public void updateFolder(final @PathParam("accountNumber") String accountNumber,
